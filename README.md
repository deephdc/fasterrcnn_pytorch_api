...
```
cd existing_repo
git remote add origin https://git.scc.kit.edu/m-team/ai/mlflow_fasterrcnn.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.scc.kit.edu/m-team/ai/mlflow_fasterrcnn/-/settings/integrations)
