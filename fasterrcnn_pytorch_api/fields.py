            ...
            for k2, v2 in v1.items():
                if k2 == 'p':
                    if not isinstance(v2, float) or not (0 <= v2 <= 1.0):
                        raise ValidationError(f"Invalid value for 'p' in {k2}: {v2}. It must be a float between 0 and 1.")
                    ...
                    if not isinstance(v2, int) or not isinstance(v2, (int, int)):
                        raise ValidationError(f"Invalid value for '{k2}': {v2}. It must be an int or (int, int).")
