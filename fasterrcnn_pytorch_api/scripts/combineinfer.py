...
from fasterrcnn_pytorch_training_pipeline.utils.transforms import (
    infer_transforms,
    resize,
)
...
class InferenceEngine:
    ...
    def infer_video(self, video_path, **args):
        ...
        with tempfile.NamedTemporaryFile(
            ...
            out = cv2.VideoWriter(
                temp_filename, fourcc, 30, (frame_width, frame_height)
            )
            json_out = {}
            frame_count = 0
            while cap.isOpened():
    ...
    def infer_single_image(self, image_path, **args):
        ...
        orig_image, json_string, fps = self.generate_json_response(
            orig_image, frame_width, **args
        )
